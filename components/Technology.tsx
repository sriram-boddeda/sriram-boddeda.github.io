...
const Technology: React.FC<TechnologyProps> = ({
  ...
  const variantClasses = {
    ...
    code: "bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 px-3 py-1 rounded-full text-xs font-medium border border-blue-200 dark:border-blue-700 hover:bg-blue-100 dark:hover:bg-blue-900/50 hover:border-blue-400 dark:hover:border-blue-500 hover:shadow-sm hover:shadow-blue-500/20 font-mono",
    ...
    pill: "px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-green-400 text-sm font-medium rounded-lg shadow-md hover:shadow-lg hover:shadow-blue-500/10 hover:bg-gray-300 dark:hover:bg-gray-600 hover:text-blue-700 dark:hover:text-blue-300 transition-all duration-300",

    // For technical skills - with icons
    icon: "flex items-center bg-gray-100 dark:bg-neutral-800 rounded-md p-1 shadow-sm text-gray-700 dark:text-gray-300 text-sm hover:bg-gray-200 dark:hover:bg-neutral-700 hover:shadow-md hover:shadow-blue-500/10 transition-all duration-300",
