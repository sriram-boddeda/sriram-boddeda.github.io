...
export const LinkedInLogo: React.FC<IconSvgProps> = ({
  ...
  //   {...props}
  // >
  //   <path fill="#0077B5" d="M6,42V6h36v36H6z"></path>
  //   <g>
  //     <path
  //       fill="#fff"
  //       d="M24.5,6.5h-17v29h29v-17H24.5V6.5z M24.5,8.5v5h5v17h-17v-5h-5V8.5H24.5z"
  //     ></path>
  //     <path
  //       fill="#fff"
  //       d="M15.5,14.5h-2.5v-2.5h2.5V14.5z M14.5,19.5h-4v-11h4V19.5z"
  //     ></path>
  //     <path
  //       fill="#fff"
  //       d="M19.5,14.5h-2.5v-2.5h2.5V14.5z M18.5,19.5h-4v-6h4V19.5z"
  //     ></path>
  //     <path
  //       fill="#fff"
  //       d="M24.5,14.5h-2.5v-2.5h2.5V14.5z M23.5,19.5h-4v-11h4V19.5z"
  //     ></path>
  //   </g>
  // </svg>
  <svg
...
export const GitHubLogo: React.FC<IconSvgProps> = ({
  ...
  //   {...props}
  // >
  //   <path fill="#000" d="M6,42V6h36v36H6z"></path>
  //   <path
  //     fill="#fff"
  //     d="M24.5,6.5h-17v29h29v-17H24.5V6.5z M24.5,8.5v5h5v17h-17v-5h-5V8.5H24.5z"
  //   ></path>
